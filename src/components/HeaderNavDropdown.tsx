...
const Anchor = styled('a')<AnchorProps>(({ theme }) => [
  {
...
const MUIAnchor: LinkComponent<typeof MUIAnchorComponent> = (props) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <li>
                <MUIAnchor to='/discover'>Discover</MUIAnchor>
              </li>
              <li>
                <MUIAnchor to='/' hash='trending'>
                  Trending
                </MUIAnchor>
              </li>
            </UList>
